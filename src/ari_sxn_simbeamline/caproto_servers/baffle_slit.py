...
class BaffleSlit(PVGroup):
    ...
    top = SubGroup(FakeMotor, velocity=1, precision=3, user_limits=(-1, 20), prefix=':Top')
    bottom = SubGroup(FakeMotor, velocity=1, precision=3, user_limits=(-20, 1), prefix=':Bottom')
    inboard = SubGroup(FakeMotor, velocity=1, precision=3, user_limits=(-20, 1), prefix=':Inboard')
    outboard = SubGroup(FakeMotor, velocity=1, precision=3, user_limits=(-1, 20), prefix=':Outboard')
