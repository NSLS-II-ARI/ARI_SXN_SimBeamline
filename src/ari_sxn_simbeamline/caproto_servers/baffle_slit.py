...
class BaffleSlit(PVGroup):
    ...
    top = SubGroup(FakeMotor, velocity=1, precision=3, user_limits=(-13, 40), prefix=':Top')
    bottom = SubGroup(FakeMotor, velocity=1, precision=3, user_limits=(-40, 13), prefix=':Bottom')
    inboard = SubGroup(FakeMotor, velocity=1, precision=3, user_limits=(-40, 13), prefix=':Inboard')
    outboard = SubGroup(FakeMotor, velocity=1, precision=3, user_limits=(-13, 40), prefix=':Outboard')
